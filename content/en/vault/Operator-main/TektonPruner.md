...
**Note:** It is recommended to install Tekton Pruner via the [TektonConfig](/vault/Operator-main/TektonConfig/) resource for consistency and ease of configuration.
