...
OpenShiftPipelinesAsCode custom resource allows the user to install and manage [OpenShift PipelinesAsCode](https://github.com/tektoncd/operator/tree/main/docs/PipelinesAsCode).

It is recommended that you install OpenShiftPipelinesAsCode through [TektonConfig](/vault/Operator-main/TektonConfig/).
...
The recommended way to update the OpenShiftPipelinesAsCode CR is using [TektonConfig](/vault/Operator-main/TektonConfig/) CR.
