...
- **[`HEAD`]** - this is the bleeding edge. It contains unreleased code that may result in unpredictable behavior. To get started, see the [development guide](https://github.com/tektoncd/dashboard/tree/main/DEVELOPMENT.md) instead of this page.
...
You can refer to the dev docs for more info on [how to use the installer](https://github.com/tektoncd/dashboard/tree/main/docs/dev/installer.md).
...
- to install with support for loading logs from an external source:
  ...
  See [Tekton Dashboard walk-through - Logs persistence](https://github.com/tektoncd/dashboard/tree/main/docs/walkthrough/walkthrough-logs.md) for details
