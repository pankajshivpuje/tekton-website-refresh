...
![Dashboard UI workloads page](/vault/Dashboard-main/dashboard-ui.jpg)

## Read the docs

- [Installing Tekton Dashboard](/vault/Dashboard-main/install/)
- Jump in with [the "Getting started" tutorial!](/vault/Dashboard-main/tutorial/)
...
- Try our [walk-throughs](https://github.com/tektoncd/dashboard/tree/main/docs/walkthrough/README.md) for more details on deploying and configuring the Tekton Dashboard for some common scenarios
- Learn how to add additional resource types to the Tekton Dashboard using [extensions](/vault/Dashboard-main/extensions/)
