...
> ℹ️ It is recommended to install Tekton Pruner via the [TektonConfig](/vault/Operator-v0.77.x-LTS/TektonConfig/) resource for consistency and ease of configuration.
