...
It is recommended to install the components through [TektonConfig](/vault/Operator-v0.78.x-LTS/TektonConfig/).
...
spec:
  ...
  - name: communityResolverTasks
    value: "true"
```
You can install this component using [TektonConfig](/vault/Operator-v0.78.x-LTS/TektonConfig/) by choosing appropriate `profile`.
