...
Refer to [properties](/vault/Operator-v0.78.x-LTS/TektonPipeline/#properties) section in TektonPipeline for available options.

Some of the fields have default values, so operator will add them if user haven't passed in CR. Other fields which
doesn't have default values won't be passed unless user specify them in CR. User can find those [here](/vault/Operator-v0.78.x-LTS/TektonPipeline/#optional-properties).
...
This section allows to customize installation of those resources through params. You can read more about the supported params [here](/vault/Operator-v0.78.x-LTS/TektonAddon/).
...
> **Note:** For advanced configurations including resource-level selectors and per-namespace overrides via ConfigMaps, refer to the [TektonPruner documentation](/vault/Operator-v0.78.x-LTS/TektonPruner/).
