...
> Make sure to take [additional precautions](https://github.com/docs/install.md#access-control)
> if your deployment is publicly accessible.
>
> READ-WRITE mode is not a requirement for Dashboard to operate, and can be
> [installed in READ-ONLY mode](https://github.com/docs/install.md#installing-tekton-dashboard-on-kubernetes).
...
1. To install the latest version of Tekton Dashboard, use `kubectl`:
   ...
   **NOTE**: release-full.yaml [installs dashboard in READ-WRITE mode](https://github.com/docs/install.md#installing-tekton-dashboard-on-kubernetes).
...
Try out some of our [walk-throughs](https://github.com/tektoncd/dashboard/tree/release-v0.60.x-lts/docs/walkthrough) for more details on deploying and configuring the
Tekton Dashboard for some common scenarios.

See [Accessing the Dashboard](/vault/Dashboard-v0.60.x-LTS/install/#accessing-the-dashboard) for details of alternative methods of exposing the Dashboard outside the cluster, including guidance for authentication and authorization.
