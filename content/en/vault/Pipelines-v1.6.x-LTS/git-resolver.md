...
- The [built-in remote resolvers installed](/vault/Pipelines-v1.6.x-LTS/install/#installing-and-configuring-remote-task-and-pipeline-resolution).
...
- [Beta features](/vault/Pipelines-v1.6.x-LTS/additional-configs/#beta-features) enabled.

## Configuration

This resolver uses a `ConfigMap` for its settings. See
[`../config/resolvers/git-resolver-config.yaml`](https://github.com/tektoncd/pipeline/tree/release-v1.6.x/config/resolvers/git-resolver-config.yaml)
