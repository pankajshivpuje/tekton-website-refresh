...
Tekton allows users to specify resource requirements of [`Steps`](/vault/Pipelines-v1.6.x-LTS/tasks/#defining-steps),
...
Kubernetes allows users to configure [LimitRanges](https://github.com/tektoncd/pipeline/tree/release-v1.6.x/docs/(https:/kubernetes.io/docs/concepts/policy/limit-range/)),
