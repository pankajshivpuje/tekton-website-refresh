...
target Pipeline to
run](/vault/Pipelines-v1.6.x-LTS/pipelineruns/#specifying-the-target-pipeline)
...
visit the
[`./resolver-template`](https://github.com/tektoncd/pipeline/tree/release-v1.6.x/docs/resolver-template)
...
- Tekton Pipelines and remote resolvers installed in your Kubernetes
  ...
  guide](/vault/Pipelines-v1.6.x-LTS/install/#installing-and-configuring-remote-task-and-pipeline-resolution) for
...
`framework.Resolver` interface](https://github.com/tektoncd/pipeline/tree/release-v1.6.x/pkg/resolution/resolver/framework/interface.go)
