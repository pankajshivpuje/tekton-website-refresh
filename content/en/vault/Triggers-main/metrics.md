...
See [config-observability.yaml](https://github.com/tektoncd/triggers/tree/main/config/config-observability.yaml) for
...
> [migration guide](/vault/Triggers-main/migration-guide-opencensus-to-opentelemetry/) for
