...
- Standalone `Interceptors`, which are instances of the [`Interceptor`](https://github.com/tektoncd/triggers/tree/main/docs/namespacedinterceptor) or the [`ClusterInterceptor`](/vault/Triggers-main/clusterinterceptors/) Custom Resource Definition (CRD). You specify these `Interceptors` by referencing them,
...
- `ref` - a reference to a [`ClusterInterceptor`](/vault/Triggers-main/clusterinterceptors/) or [`Interceptor`](/vault/Triggers-main/namespacedinterceptors/) object with the following fields:
...
For more information, see our [example](https://github.com/tektoncd/triggers/tree/main/examples/v1beta1/github) of using this `Interceptor`.
...
- [github-add-changed-files-pr](https://github.com/tektoncd/triggers/tree/main/examples/v1beta1/github-add-changed-files-pr)
- [github-add-changed-files-push-cel](https://github.com/tektoncd/triggers/tree/main/examples/v1beta1/github-add-changed-files-push-cel)
...
- [github-owners](https://github.com/tektoncd/triggers/tree/main/examples/v1beta1/github-owners)
