...
used in a [`TriggerTemplate`](/vault/Triggers-main/triggertemplates/). For instance, one can extract the commit SHA from an incoming event
...
## Accessing data added by [`Interceptors`](/vault/Triggers-main/interceptors/)
