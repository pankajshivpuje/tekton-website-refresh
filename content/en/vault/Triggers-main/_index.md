...
*  [`EventListener`](/vault/Triggers-main/eventlisteners/) - listens for events at a specified port on your Kubernetes cluster.
   Specifies one or more `Triggers`.

*  [`Trigger`](/vault/Triggers-main/triggers/) - specifies what happens when the `EventListener` detects an event. A `Trigger` specifies
   a `TriggerTemplate`, a `TriggerBinding`, and optionally, an `Interceptor`.

*  [`TriggerTemplate`](/vault/Triggers-main/triggertemplates/) - specifies a blueprint for the resource, such as a `TaskRun` or `PipelineRun`,
...
*  [`TriggerBinding`](/vault/Triggers-main/triggerbindings/) - specifies the fields in the event payload from which you want to extract
...
*  [`ClusterTriggerBinding`](/vault/Triggers-main/triggerbindings/) - a cluster-scoped version of the `TriggerBinding`,
   especially useful for reuse within your cluster.

*  [`Interceptor`](/vault/Triggers-main/interceptors/) - a "catch-all" event processor for a specific platform that
...
![TriggerFlow](https://raw.github.com/tektoncd/triggers/main/docs/images/TriggerFlow.svg)
...
*   [Setting Up Tekton Triggers](/vault/Triggers-main/install/)
...
*   [Troubleshooting Tekton Triggers](/vault/Triggers-main/troubleshooting/)
