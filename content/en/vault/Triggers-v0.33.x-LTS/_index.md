...
*  [`EventListener`](/vault/Triggers-v0.33.x-LTS/eventlisteners/) - listens for events at a specified port on your Kubernetes cluster.
   Specifies one or more `Triggers`.

*  [`Trigger`](/vault/Triggers-v0.33.x-LTS/triggers/) - specifies what happens when the `EventListener` detects an event. A `Trigger` specifies
   a `TriggerTemplate`, a `TriggerBinding`, and optionally, an `Interceptor`.

*  [`TriggerTemplate`](/vault/Triggers-v0.33.x-LTS/triggertemplates/) - specifies a blueprint for the resource, such as a `TaskRun` or `PipelineRun`,
...
*  [`TriggerBinding`](/vault/Triggers-v0.33.x-LTS/triggerbindings/) - specifies the fields in the event payload from which you want to extract
...
*  [`ClusterTriggerBinding`](/vault/Triggers-v0.33.x-LTS/triggerbindings/) - a cluster-scoped version of the `TriggerBinding`,
   especially useful for reuse within your cluster.

*  [`Interceptor`](/vault/Triggers-v0.33.x-LTS/interceptors/) - a "catch-all" event processor for a specific platform that
...
![TriggerFlow](https://raw.github.com/tektoncd/triggers/release-v0.33.x/docs/images/TriggerFlow.svg)
...
*   [Setting Up Tekton Triggers](/vault/Triggers-v0.33.x-LTS/install/)
...
*   [Troubleshooting Tekton Triggers](/vault/Triggers-v0.33.x-LTS/troubleshooting/)
