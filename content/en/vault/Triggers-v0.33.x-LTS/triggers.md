...
A `Trigger` specifies what happens when the [`EventListener`](/vault/Triggers-v0.33.x-LTS/eventlisteners/) detects an event. A `Trigger` specifies a [`TriggerTemplate`](/vault/Triggers-v0.33.x-LTS/triggertemplates/),
a [`TriggerBinding`](/vault/Triggers-v0.33.x-LTS/triggerbindings/), and optionally an [`Interceptor`](/vault/Triggers-v0.33.x-LTS/interceptors/).
