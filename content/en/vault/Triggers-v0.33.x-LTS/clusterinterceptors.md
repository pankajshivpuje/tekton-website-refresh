...
top-level `extensions` field to other [`Interceptors`](/vault/Triggers-v0.33.x-LTS/interceptors/) and `ClusterInterceptors` chained with it and the associated `TriggerBinding`.
