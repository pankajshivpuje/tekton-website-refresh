...
- Standalone `Interceptors`, which are instances of the [`Interceptor`](https://github.com/tektoncd/triggers/tree/release-v0.33.x/docs/namespacedinterceptor) or the [`ClusterInterceptor`](/vault/Triggers-v0.33.x-LTS/clusterinterceptors/) Custom Resource Definition (CRD). You specify these `Interceptors` by referencing them,
...
- `ref` - a reference to a [`ClusterInterceptor`](/vault/Triggers-v0.33.x-LTS/clusterinterceptors/) or [`Interceptor`](/vault/Triggers-v0.33.x-LTS/namespacedinterceptors/) object with the following fields:
...
For more information, see our [example](https://github.com/tektoncd/triggers/tree/release-v0.33.x/examples/v1beta1/github) of using this `Interceptor`.
...
- [github-add-changed-files-pr](https://github.com/tektoncd/triggers/tree/release-v0.33.x/examples/v1beta1/github-add-changed-files-pr)
- [github-add-changed-files-push-cel](https://github.com/tektoncd/triggers/tree/release-v0.33.x/examples/v1beta1/github-add-changed-files-push-cel)
...
- [github-owners](https://github.com/tektoncd/triggers/tree/release-v0.33.x/examples/v1beta1/github-owners)
