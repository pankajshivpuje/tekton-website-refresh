...
It is recommended to install the components through [TektonConfig](/vault/Operator-v0.73.x-LTS/TektonConfig/).
...
spec:
  ...
  readonly: false
```
You can install this component using [TektonConfig](/vault/Operator-v0.73.x-LTS/TektonConfig/) by choosing appropriate `profile`.
