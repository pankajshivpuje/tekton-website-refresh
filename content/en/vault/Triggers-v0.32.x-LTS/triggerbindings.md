...
used in a [`TriggerTemplate`](/vault/Triggers-v0.32.x-LTS/triggertemplates/). For instance, one can extract the commit SHA from an incoming event
...
## Accessing data added by [`Interceptors`](/vault/Triggers-v0.32.x-LTS/interceptors/)
...
You can specify multiple bindings within the `Trigger` definition in your [`EventListener`](/vault/Triggers-v0.32.x-LTS/eventlisteners/).
