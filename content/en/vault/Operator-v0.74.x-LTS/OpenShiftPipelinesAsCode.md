...
OpenShiftPipelinesAsCode custom resource allows the user to install and manage [OpenShift PipelinesAsCode](https://github.com/tektoncd/operator/tree/release-v0.74.x/docs/PipelinesAsCode).

It is recommended that you install OpenShiftPipelinesAsCode through [TektonConfig](/vault/Operator-v0.74.x-LTS/TektonConfig/).
...
The recommended way to update the OpenShiftPipelinesAsCode CR is using [TektonConfig](/vault/Operator-v0.74.x-LTS/TektonConfig/) CR.
