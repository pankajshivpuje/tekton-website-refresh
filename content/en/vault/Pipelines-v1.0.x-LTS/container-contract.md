...
Each container image that executes a `Step` in a [`Task`](/vault/Pipelines-v1.0.x-LTS/tasks/) must
...
However, if you're using the [`script` field](/vault/Pipelines-v1.0.x-LTS/tasks/#running-scripts-within-steps) to
