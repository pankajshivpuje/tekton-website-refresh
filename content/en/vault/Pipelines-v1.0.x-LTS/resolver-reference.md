...
template](https://github.com/tektoncd/pipeline/tree/release-v1.0.x/docs/resolver-template), or for a howto guide see [how to write
a resolver](/vault/Pipelines-v1.0.x-LTS/how-to-write-a-resolver/).
