...
[Why aren't PipelineResources in Beta?](/vault/Pipelines-v1.0.x-LTS/resources/#why-aren-t-pipelineresources-in-beta)._
...
a [`result`](/vault/Pipelines-v1.0.x-LTS/tasks/#emitting-results)), and also that now the `Task` doesn't need to know anything
...
`Tasks` in your `Pipeline`, you can use [`Task` results](/vault/Pipelines-v1.0.x-LTS/tasks/#emitting-results) to
