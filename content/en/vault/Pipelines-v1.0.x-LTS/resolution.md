...
[resolution-getting-started.md](/vault/Pipelines-v1.0.x-LTS/resolution-getting-started/) tutorial.
...
ConfigMap in the `tekton-pipelines-resolvers` namespace. See the [section in install.md](/vault/Pipelines-v1.0.x-LTS/install/#configuring-built-in-remote-task-and-pipeline-resolution) for details.
...
[how-to-write-a-resolver.md](/vault/Pipelines-v1.0.x-LTS/how-to-write-a-resolver/) and the
accompanying [resolver-template](https://github.com/tektoncd/pipeline/tree/release-v1.0.x/docs/resolver-template).
...
along with those that are optional, see [resolver-reference.md](/vault/Pipelines-v1.0.x-LTS/resolver-reference/).
