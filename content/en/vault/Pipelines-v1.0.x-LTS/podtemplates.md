...
You also have the option to define a global Pod template [in your Tekton config](/vault/Pipelines-v1.0.x-LTS/additional-configs/#customizing-basic-execution-parameters) using the key `default-pod-template`.
...
- [Specifying a Pod template for a `TaskRun`](/vault/Pipelines-v1.0.x-LTS/taskruns/#specifying-a-pod-template)
- [Specifying a Pod template for a `PipelineRun`](/vault/Pipelines-v1.0.x-LTS/pipelineruns/#specifying-a-pod-template)
...
assistant Pod template [in your Tekton config](/vault/Pipelines-v1.0.x-LTS/additional-configs/#customizing-basic-execution-parameters)
