...
See [the installation instructions for Tekton Pipeline](/vault/Pipelines-v1.0.x-LTS/install/#installing-tekton-pipelines-on-kubernetes), and
[the installation instructions for the built-in resolvers](/vault/Pipelines-v1.0.x-LTS/install/#installing-and-configuring-remote-task-and-pipeline-resolution).
