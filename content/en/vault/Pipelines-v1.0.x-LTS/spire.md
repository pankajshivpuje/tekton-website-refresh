...
1. Make sure `enforce-nonfalsifiability` is set to `"spire"`. See [`additional-configs.md`](/vault/Pipelines-v1.0.x-LTS/additional-configs/#customizing-the-pipelines-controller-behavior) for details
