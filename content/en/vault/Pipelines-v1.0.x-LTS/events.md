...
When you [configure a sink](/vault/Pipelines-v1.0.x-LTS/additional-configs/#configuring-cloudevents-notifications), Tekton emits
...
`CloudEvents` for `Runs` are only sent when enabled in the [configuration](/vault/Pipelines-v1.0.x-LTS/additional-configs/#configuring-cloudevents-notifications).
