...
> :warning: **`PipelineResources` are [deprecated](/vault/Pipelines-v1.3.x-LTS/deprecations/#deprecation-table).**
>
> Consider using replacement features instead. Read more in [documentation](/vault/Pipelines-v1.3.x-LTS/migrating-v1alpha1-to-v1beta1/#replacing-pipelineresources-with-tasks)
...
> `PipelineResources` are now [deprecated](/vault/Pipelines-v1.3.x-LTS/deprecations/#deprecation-table).** 
>
> For Beta-supported alternatives to PipelineResources see
> [the v1alpha1 to v1beta1 migration guide](/vault/Pipelines-v1.3.x-LTS/migrating-v1alpha1-to-v1beta1/#pipelineresources-and-catalog-tasks)
