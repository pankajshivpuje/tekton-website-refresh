...
Multi-tenant installation is only partially supported today, read the [guide](https://github.com/tektoncd/pipeline/tree/release-v1.3.x/docs/developers/multi-tenant-support.md)
for reference.
...
[additional configuration options](/vault/Pipelines-v1.3.x-LTS/additional-configs/) for more information.
