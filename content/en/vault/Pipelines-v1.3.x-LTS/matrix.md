...
- [Specifying `Matrix` in `Tasks`](/vault/Pipelines-v1.3.x-LTS/pipelines/#specifying-matrix-in-pipelinetasks)
- [Specifying `Matrix` in `Finally Tasks`](/vault/Pipelines-v1.3.x-LTS/pipelines/#specifying-matrix-in-finally-tasks)
- [Specifying `Matrix` in `Custom Tasks`](/vault/Pipelines-v1.3.x-LTS/pipelines/#specifying-matrix)
...
For more information, see [installation customizations](/vault/Pipelines-v1.3.x-LTS/additional-configs/#customizing-basic-execution-parameters).
...
`PipelineTasks`, see [documentation](/vault/Pipelines-v1.3.x-LTS/pipelines/#specifying-parameters).
