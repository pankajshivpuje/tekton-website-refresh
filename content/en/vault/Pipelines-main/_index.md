...
- [Creating a Task](/vault/Pipelines-main/tasks/)
- [Running a standalone Task](/vault/Pipelines-main/taskruns/)
- [Creating a Pipeline](/vault/Pipelines-main/pipelines/)
- [Running a Pipeline](/vault/Pipelines-main/pipelineruns/)
- [Defining Workspaces](/vault/Pipelines-main/workspaces/)
- [Configuring authentication](/vault/Pipelines-main/auth/)
- [Using labels](/vault/Pipelines-main/labels/)
- [Viewing logs](/vault/Pipelines-main/logs/)
- [Pipelines metrics](/vault/Pipelines-main/metrics/)
- [Variable Substitutions](/vault/Pipelines-main/tasks/#using-variable-substitution)
- [Running a Custom Task](/vault/Pipelines-main/customruns/)
- [Remote resolution of Pipelines and Tasks](/vault/Pipelines-main/resolution/)
- [Trusted Resources](/vault/Pipelines-main/trusted-resources/)
