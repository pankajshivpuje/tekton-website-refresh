...
target Pipeline to
run](/vault/Pipelines-main/pipelineruns/#specifying-the-target-pipeline)
...
- Tekton Pipelines and remote resolvers installed in your Kubernetes
  ...
  guide](/vault/Pipelines-main/install/#installing-and-configuring-remote-task-and-pipeline-resolution) for
...
`framework.Resolver` interface](https://github.com/tektoncd/pipeline/tree/main/pkg/resolution/resolver/framework/interface.go)
