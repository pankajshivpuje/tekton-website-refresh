...
[observability ConfigMap](https://github.com/tektoncd/pipeline/tree/main/config/config-observability.yaml). By default,
...
(see [migration guide](/vault/Pipelines-main/metrics-migration-otel/) for full details).
...
A sample ConfigMap has been provided as [config-observability](https://github.com/tektoncd/pipeline/tree/main/config/config-observability.yaml).
...
> [migration guide](/vault/Pipelines-main/metrics-migration-otel/) for details on upgrading.
