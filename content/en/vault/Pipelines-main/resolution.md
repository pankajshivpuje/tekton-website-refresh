...
[resolution-getting-started.md](/vault/Pipelines-main/resolution-getting-started/) tutorial.
...
ConfigMap in the `tekton-pipelines-resolvers` namespace. See the [section in install.md](/vault/Pipelines-main/install/#configuring-built-in-remote-task-and-pipeline-resolution) for details.
...
[how-to-write-a-resolver.md](/vault/Pipelines-main/how-to-write-a-resolver/) and the
accompanying [resolver-template](https://github.com/tektoncd/pipeline/tree/main/docs/resolver-template).
...
along with those that are optional, see [resolver-reference.md](/vault/Pipelines-main/resolver-reference/).
