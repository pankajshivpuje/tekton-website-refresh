...
1. Make sure `enforce-nonfalsifiability` is set to `"spire"`. See [`additional-configs.md`](/vault/Pipelines-main/additional-configs/#customizing-the-pipelines-controller-behavior) for details
