...
- The [built-in remote resolvers installed](/vault/Pipelines-main/install/#installing-and-configuring-remote-task-and-pipeline-resolution).
...
- [Beta features](/vault/Pipelines-main/additional-configs/#beta-features) enabled.

## Configuration

This resolver uses a `ConfigMap` for its settings. See
[`../config/resolvers/git-resolver-config.yaml`](https://github.com/tektoncd/pipeline/tree/main/config/resolvers/git-resolver-config.yaml)
