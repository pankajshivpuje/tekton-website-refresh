...
see [`authenticating-git-commands`](https://github.com/tektoncd/pipeline/tree/main/examples/v1/taskruns/authenticating-git-commands.yaml).
...
For a complete example, see [`git-basic-auth-multiple-repos.yaml`](https://github.com/tektoncd/pipeline/tree/main/examples/v1/taskruns/no-ci/git-basic-auth-multiple-repos.yaml).
...
For a complete example, see [`git-ssh-auth-multiple-repos.yaml`](https://github.com/tektoncd/pipeline/tree/main/examples/v1/taskruns/no-ci/git-ssh-auth-multiple-repos.yaml).
...
For example usage, see [`authenticating-git-commands`](https://github.com/tektoncd/pipeline/tree/main/examples/v1/taskruns/authenticating-git-commands.yaml).
...
[using a feature-flag: `require-git-ssh-secret-known-hosts`](/vault/Pipelines-main/install/#customizing-the-pipelines-controller-behavior).
...
TaskRun's `Pod template` field](/vault/Pipelines-main/taskruns/#specifying-a-pod-template).
...
1. Credentials must now be passed explicitly to Tasks either with [Workspaces](/vault/Pipelines-main/workspaces/#using-workspaces-in-tasks),
