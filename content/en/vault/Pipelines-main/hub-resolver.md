...
[`../config/resolvers/hubresolver-config.yaml`](https://github.com/tektoncd/pipeline/tree/main/config/resolvers/hubresolver-config.yaml)
...
[`../config/resolvers/resolvers-deployment.yaml`](https://github.com/tektoncd/pipeline/tree/main/config/resolvers/resolvers-deployment.yaml). Example:
