...
[Why aren't PipelineResources in Beta?](/vault/Pipelines-main/resources/#why-aren-t-pipelineresources-in-beta)._
...
a [`result`](/vault/Pipelines-main/tasks/#emitting-results)), and also that now the `Task` doesn't need to know anything
...
`Tasks` in your `Pipeline`, you can use [`Task` results](/vault/Pipelines-main/tasks/#emitting-results) to
