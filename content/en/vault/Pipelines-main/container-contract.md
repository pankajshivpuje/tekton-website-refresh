...
Each container image that executes a `Step` in a [`Task`](/vault/Pipelines-main/tasks/) must
...
However, if you're using the [`script` field](/vault/Pipelines-main/tasks/#running-scripts-within-steps) to
