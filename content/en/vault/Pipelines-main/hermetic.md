...
1. Make sure `enable-api-fields` is set to `"alpha"` in the `feature-flags` configmap, see [`install.md`](/vault/Pipelines-main/install/#customizing-the-pipelines-controller-behavior) for details
