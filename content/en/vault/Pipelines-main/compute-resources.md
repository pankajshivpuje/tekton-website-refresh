...
Tekton allows users to specify resource requirements of [`Steps`](/vault/Pipelines-main/tasks/#defining-steps),
...
Kubernetes allows users to configure [LimitRanges](https://github.com/tektoncd/pipeline/tree/main/docs/(https:/kubernetes.io/docs/concepts/policy/limit-range/)),
