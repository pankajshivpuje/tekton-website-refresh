...
- [Specifying `Matrix` in `Tasks`](/vault/Pipelines-main/pipelines/#specifying-matrix-in-pipelinetasks)
- [Specifying `Matrix` in `Finally Tasks`](/vault/Pipelines-main/pipelines/#specifying-matrix-in-finally-tasks)
- [Specifying `Matrix` in `Custom Tasks`](/vault/Pipelines-main/pipelines/#specifying-matrix)
...
For more information, see [installation customizations](/vault/Pipelines-main/additional-configs/#customizing-basic-execution-parameters).
...
`PipelineTasks`, see [documentation](/vault/Pipelines-main/pipelines/#specifying-parameters).
