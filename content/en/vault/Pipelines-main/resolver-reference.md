...
template](https://github.com/tektoncd/pipeline/tree/main/docs/resolver-template), or for a howto guide see [how to write
a resolver](/vault/Pipelines-main/how-to-write-a-resolver/).
