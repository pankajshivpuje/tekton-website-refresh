...
Multi-tenant installation is only partially supported today, read the [guide](https://github.com/tektoncd/pipeline/tree/main/docs/developers/multi-tenant-support.md)
for reference.
...
[additional configuration options](/vault/Pipelines-main/additional-configs/) for more information.
