...
- [Time-based Pruning](/docs/pruner/time-based-pruning/) - Age-based deletion
- [Namespace Configuration](/docs/pruner/namespace-configuration/) - Per-environment limits
- [Resource Groups](/docs/pruner/resource-groups/) - Pipeline-specific limits