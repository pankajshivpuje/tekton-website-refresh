...
- [Namespace Configuration](/docs/pruner/namespace-configuration/) - Set up namespace ConfigMaps
- [Time-based Pruning](/docs/pruner/time-based-pruning/) - TTL strategies for groups
- [History-based Pruning](/docs/pruner/history-based-pruning/) - Retention strategies for groups