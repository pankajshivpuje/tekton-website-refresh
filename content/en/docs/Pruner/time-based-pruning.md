...
- [History-based Pruning](/docs/pruner/history-based-pruning/) - Retain N runs regardless of age
- [Namespace Configuration](/docs/pruner/namespace-configuration/) - Per-environment TTL settings
- [Resource Groups](/docs/pruner/resource-groups/) - Pipeline-specific TTLs via selectors