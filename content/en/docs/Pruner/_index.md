...
> 📖 **For comprehensive architecture details, design decisions, and data flows, see [ARCHITECTURE.md](https://github.com/tektoncd/pruner/tree/main/ARCHITECTURE.md)**
...
- [Getting Started](/docs/pruner/getting-started/)
- [Namespace Configuration](/docs/pruner/namespace-configuration/)
- [Resource Groups](/docs/pruner/resource-groups/)
- [ConfigMap Validation](/docs/pruner/configmap-validation/) - How ConfigMaps are validated by the webhook

## Contributing

- See [DEVELOPMENT.md](https://github.com/tektoncd/pruner/tree/main/DEVELOPMENT.md) for development setup
- Submit issues and pull requests
- Follow coding standards and test coverage requirements

## License

Apache License 2.0 - See [LICENSE](https://github.com/tektoncd/pruner/tree/main/LICENSE) for details