...
![Dashboard UI workloads page](/docs/dashboard/dashboard-ui.jpg)

## Read the docs

- [Installing Tekton Dashboard](/docs/dashboard/install/)
- Jump in with [the "Getting started" tutorial!](/docs/dashboard/tutorial/)
...
- Try our [walk-throughs](https://github.com/tektoncd/dashboard/tree/release-v0.65.x-lts/docs/walkthrough/README.md) for more details on deploying and configuring the Tekton Dashboard for some common scenarios
- Learn how to add additional resource types to the Tekton Dashboard using [extensions](/docs/dashboard/extensions/)
