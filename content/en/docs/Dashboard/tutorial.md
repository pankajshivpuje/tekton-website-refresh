...
Try out some of our [walk-throughs](https://github.com/tektoncd/dashboard/tree/release-v0.65.x-lts/docs/walkthrough) for more details on deploying and configuring the
Tekton Dashboard for some common scenarios.

See [Accessing the Dashboard](/docs/dashboard/install/#accessing-the-dashboard) for details of alternative methods of exposing the Dashboard outside the cluster, including guidance for authentication and authorization.
