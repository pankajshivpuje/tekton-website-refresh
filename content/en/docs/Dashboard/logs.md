...
This functionality is described in detail, along with a full walk-through of an example configuration, in [Tekton Dashboard walk-through - Logs persistence](https://github.com/tektoncd/dashboard/tree/release-v0.65.x-lts/docs/walkthrough/walkthrough-logs.md).
