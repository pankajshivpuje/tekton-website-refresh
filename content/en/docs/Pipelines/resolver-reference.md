...
template](https://github.com/tektoncd/pipeline/tree/release-v1.9.x/docs/resolver-template), or for a howto guide see [how to write
a resolver](/docs/pipelines/how-to-write-a-resolver/).
