...
See [the installation instructions for Tekton Pipeline](/docs/pipelines/install/#installing-tekton-pipelines-on-kubernetes), and
[the installation instructions for the built-in resolvers](/docs/pipelines/install/#installing-and-configuring-remote-task-and-pipeline-resolution).
