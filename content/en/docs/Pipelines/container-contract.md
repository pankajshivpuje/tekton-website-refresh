...
Each container image that executes a `Step` in a [`Task`](/docs/pipelines/tasks/) must
...
However, if you're using the [`script` field](/docs/pipelines/tasks/#running-scripts-within-steps) to
