...
- [Specifying `Matrix` in `Tasks`](/docs/pipelines/pipelines/#specifying-matrix-in-pipelinetasks)
- [Specifying `Matrix` in `Finally Tasks`](/docs/pipelines/pipelines/#specifying-matrix-in-finally-tasks)
- [Specifying `Matrix` in `Custom Tasks`](/docs/pipelines/pipelines/#specifying-matrix)
...
For more information, see [installation customizations](/docs/pipelines/additional-configs/#customizing-basic-execution-parameters).
...
`PipelineTasks`, see [documentation](/docs/pipelines/pipelines/#specifying-parameters).
