...
- [Running a Custom Task](/docs/pipelines/customruns/)
- [Remote resolution of Pipelines and Tasks](/docs/pipelines/resolution/)
- [Trusted Resources](/docs/pipelines/trusted-resources/)
