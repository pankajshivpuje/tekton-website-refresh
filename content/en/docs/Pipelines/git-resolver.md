...
- The [built-in remote resolvers installed](/docs/pipelines/install/#installing-and-configuring-remote-task-and-pipeline-resolution).
...
- [Beta features](/docs/pipelines/additional-configs/#beta-features) enabled.

## Configuration

This resolver uses a `ConfigMap` for its settings. See
[`../config/resolvers/git-resolver-config.yaml`](https://github.com/tektoncd/pipeline/tree/release-v1.9.x/config/resolvers/git-resolver-config.yaml)
