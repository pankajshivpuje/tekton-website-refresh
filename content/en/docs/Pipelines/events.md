...
When you [configure a sink](/docs/pipelines/additional-configs/#configuring-cloudevents-notifications), Tekton emits
...
`CloudEvents` for `Runs` are only sent when enabled in the [configuration](/docs/pipelines/additional-configs/#configuring-cloudevents-notifications).
