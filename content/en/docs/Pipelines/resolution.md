...
[resolution-getting-started.md](/docs/pipelines/resolution-getting-started/) tutorial.
...
ConfigMap in the `tekton-pipelines-resolvers` namespace. See the [section in install.md](/docs/pipelines/install/#configuring-built-in-remote-task-and-pipeline-resolution) for details.
...
[how-to-write-a-resolver.md](/docs/pipelines/how-to-write-a-resolver/) and the
accompanying [resolver-template](https://github.com/tektoncd/pipeline/tree/release-v1.9.x/docs/resolver-template).
...
along with those that are optional, see [resolver-reference.md](/docs/pipelines/resolver-reference/).
