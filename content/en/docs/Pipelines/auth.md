...
see [`authenticating-git-commands`](https://github.com/tektoncd/pipeline/tree/release-v1.9.x/examples/v1/taskruns/authenticating-git-commands.yaml).
...
For example usage, see [`authenticating-git-commands`](https://github.com/tektoncd/pipeline/tree/release-v1.9.x/examples/v1/taskruns/authenticating-git-commands.yaml).
...
[using a feature-flag: `require-git-ssh-secret-known-hosts`](/docs/pipelines/install/#customizing-the-pipelines-controller-behavior).
...
TaskRun's `Pod template` field](/docs/pipelines/taskruns/#specifying-a-pod-template).
...
1. Credentials must now be passed explicitly to Tasks either with [Workspaces](/docs/pipelines/workspaces/#using-workspaces-in-tasks),
