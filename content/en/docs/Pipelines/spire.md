...
1. Make sure `enforce-nonfalsifiability` is set to `"spire"`. See [`additional-configs.md`](/docs/pipelines/additional-configs/#customizing-the-pipelines-controller-behavior) for details
