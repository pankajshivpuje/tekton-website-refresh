...
> :warning: **`PipelineResources` are [deprecated](/docs/pipelines/deprecations/#deprecation-table).**
>
> Consider using replacement features instead. Read more in [documentation](/docs/pipelines/migrating-v1alpha1-to-v1beta1/#replacing-pipelineresources-with-tasks)
...
> `PipelineResources` are now [deprecated](/docs/pipelines/deprecations/#deprecation-table).** 
>
> For Beta-supported alternatives to PipelineResources see
> [the v1alpha1 to v1beta1 migration guide](/docs/pipelines/migrating-v1alpha1-to-v1beta1/#pipelineresources-and-catalog-tasks)
