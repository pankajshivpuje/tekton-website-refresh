...
target Pipeline to
run](/docs/pipelines/pipelineruns/#specifying-the-target-pipeline)
...
visit the
[`./resolver-template`](https://github.com/tektoncd/pipeline/tree/release-v1.9.x/docs/resolver-template)
...
- Tekton Pipelines and remote resolvers installed in your Kubernetes
  ...
  guide](/docs/pipelines/install/#installing-and-configuring-remote-task-and-pipeline-resolution) for
...
`framework.Resolver` interface](https://github.com/tektoncd/pipeline/tree/release-v1.9.x/pkg/resolution/resolver/framework/interface.go)
