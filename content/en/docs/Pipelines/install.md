...
Multi-tenant installation is only partially supported today, read the [guide](https://github.com/tektoncd/pipeline/tree/release-v1.9.x/docs/developers/multi-tenant-support.md)
for reference.
...
[additional configuration options](/docs/pipelines/additional-configs/) for more information.
