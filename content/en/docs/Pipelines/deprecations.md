...
as of release v0.50.0. Following the [beta CRD compatibility policy](https://github.com/tektoncd/pipeline/tree/release-v1.9.x/api_compatibility_policy.md#beta-crds),
