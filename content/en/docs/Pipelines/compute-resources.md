...
Tekton allows users to specify resource requirements of [`Steps`](/docs/pipelines/tasks/#defining-steps),
...
Kubernetes allows users to configure [LimitRanges](https://github.com/tektoncd/pipeline/tree/release-v1.9.x/docs/(https:/kubernetes.io/docs/concepts/policy/limit-range/)),
