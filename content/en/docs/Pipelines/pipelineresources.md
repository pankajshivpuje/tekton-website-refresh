...
[Why aren't PipelineResources in Beta?](/docs/pipelines/resources/#why-aren-t-pipelineresources-in-beta)._
...
a [`result`](/docs/pipelines/tasks/#emitting-results)), and also that now the `Task` doesn't need to know anything
...
`Tasks` in your `Pipeline`, you can use [`Task` results](/docs/pipelines/tasks/#emitting-results) to
