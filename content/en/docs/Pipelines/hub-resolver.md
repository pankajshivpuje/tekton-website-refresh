...
[`../config/resolvers/hubresolver-config.yaml`](https://github.com/tektoncd/pipeline/tree/release-v1.9.x/config/resolvers/hubresolver-config.yaml)
...
[`../config/resolvers/resolvers-deployment.yaml`](https://github.com/tektoncd/pipeline/tree/release-v1.9.x/config/resolvers/resolvers-deployment.yaml). Example:
