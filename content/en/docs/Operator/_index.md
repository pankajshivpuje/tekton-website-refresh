...
- Install from code
  ...
  You can clone and repository and install the Operator. You can find the instruction in [here](https://github.com/tektoncd/operator/tree/release-v0.79.x/DEVELOPMENT.md)

After installing the Operator, to install the required Tekton Component such as Tekton Pipeline, Tekton Triggers.

Create an instance of `TektonConfig` which will create the required components. You can find more details and the available configuration in [TektonConfig](/docs/operator/TektonConfig/).
...
- [TektonConfig](/docs/operator/TektonConfig/)
...
To understand how Tekton Operator works, you can find the details [here](https://github.com/tektoncd/operator/tree/release-v0.79.x/docs/TektonOperator.md)

## Tektoncd Operator Releases

  [Tektoncd Releases](https://github.com/tektoncd/operator/tree/release-v0.79.x/docs/release/README.md)
