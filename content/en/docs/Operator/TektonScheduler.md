...
* Scheduler component  internally uses  [Kueue](https://github.com/tektoncd/operator/tree/release-v0.79.x/docs/:https:/kueue.sigs.k8s.io)  for its  functioning so it is required to have kueue installed before we can enable the tekton-scheduler.
* Scheduler component also uses [cert-manager](https://github.com/tektoncd/operator/tree/release-v0.79.x/docs/:https:/github.com/cert-manager/cert-manager) so you must install the cert-manager CRDs before scheduler can be enabled.
...
[Scheduler](https://github.com/tektoncd/operator/tree/release-v0.79.x/docs/:https:/github.com/konflux-ci/tekton-kueue)
