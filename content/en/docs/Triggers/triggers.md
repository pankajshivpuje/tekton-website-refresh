...
A `Trigger` specifies what happens when the [`EventListener`](/docs/triggers/eventlisteners/) detects an event. A `Trigger` specifies a [`TriggerTemplate`](/docs/triggers/triggertemplates/),
a [`TriggerBinding`](/docs/triggers/triggerbindings/), and optionally an [`Interceptor`](/docs/triggers/interceptors/).
