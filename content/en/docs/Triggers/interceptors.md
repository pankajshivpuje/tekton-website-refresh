...
- Standalone `Interceptors`, which are instances of the [`Interceptor`](https://github.com/tektoncd/triggers/tree/release-v0.34.x/docs/namespacedinterceptor) or the [`ClusterInterceptor`](/docs/triggers/clusterinterceptors/) Custom Resource Definition (CRD). You specify these `Interceptors` by referencing them,
...
- `ref` - a reference to a [`ClusterInterceptor`](/docs/triggers/clusterinterceptors/) or [`Interceptor`](/docs/triggers/namespacedinterceptors/) object with the following fields:
...
For more information, see our [example](https://github.com/tektoncd/triggers/tree/release-v0.34.x/examples/v1beta1/github) of using this `Interceptor`.
...
- [github-add-changed-files-pr](https://github.com/tektoncd/triggers/tree/release-v0.34.x/examples/v1beta1/github-add-changed-files-pr)
- [github-add-changed-files-push-cel](https://github.com/tektoncd/triggers/tree/release-v0.34.x/examples/v1beta1/github-add-changed-files-push-cel)
...
- [github-owners](https://github.com/tektoncd/triggers/tree/release-v0.34.x/examples/v1beta1/github-owners)
...
Tekton Triggers ships with the `ClusterInterceptor`and `Interceptor` Custom Resource Definition (CRD), which you can use to implement custom `Interceptors`. See [`ClusterInterceptors`](/docs/triggers/clusterinterceptors/) and [`NamespacedInterceptors`](/docs/triggers/namespacedinterceptors/)  for more information.
