...
used in a [`TriggerTemplate`](/docs/triggers/triggertemplates/). For instance, one can extract the commit SHA from an incoming event
...
## Accessing data added by [`Interceptors`](/docs/triggers/interceptors/)
...
You can specify multiple bindings within the `Trigger` definition in your [`EventListener`](/docs/triggers/eventlisteners/).
