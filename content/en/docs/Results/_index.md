...
- A [queryable gRPC API server](https://github.com/tektoncd/results/tree/main/docs/api) backed by persistent storage (see
  [proto/v1alpha2](https://github.com/tektoncd/results/tree/main/proto/v1alpha2) for the latest API spec).
- A [controller to watch and report](https://github.com/tektoncd/results/tree/main/docs/watcher) TaskRun and PipelineRun updates
  to the API server.
- A [retention policy agent](https://github.com/tektoncd/results/tree/main/docs/retention-policy-agent), an agent which deletes older data from DB.
...
1. [Installation](https://github.com/tektoncd/results/tree/main/docs/install.md)
2. [Results API](/docs/results/api/): Learn how to connect to the API and make
   queries.
3. [Watcher](/docs/results/watcher/): Learn what types the Watcher supports and how
...
- [Roadmap](https://github.com/tektoncd/results/tree/main/docs/roadmap.md)
- [Results API Query Cookbook](/docs/results/api/#cookbook)
