...
1. The Chains controller will be pushing signatures to an OCI registry using the credentials linked to your `TaskRun`'s service account. See our [authentication doc](/docs/chains/authentication/)
...
First, apply the [Kaniko Task](https://github.com/tektoncd/chains/tree/main/examples/kaniko/kaniko.yaml) to your cluster:
...
![signed-provenance-setup](https://raw.github.com/tektoncd/chains/main/docs/tutorials/images/signed_provenance.png)
