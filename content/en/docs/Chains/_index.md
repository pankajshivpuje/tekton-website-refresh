...
- Attestation formats like [slsa/v1](/docs/chains/slsa-provenance/#how-to-configure-tekton-chains)
...
- [Add authentication to the Chains controller](/docs/chains/authentication/)
- [Generate a cryptographic key and configure Chains to use it for signing](/docs/chains/signing/)
- [Set up any additional configuration](/docs/chains/config/)
...
[getting started tutorial](/docs/chains/getting-started-tutorial/).

To start signing OCI images and generating signed provenance for them, try our
[signed provenance tutorial](/docs/chains/signed-provenance-tutorial/).
...
[experimental.md](/docs/chains/experimental/)

## Want to contribute

We are so excited to have you!

- See [CONTRIBUTING.md](https://github.com/tektoncd/chains/tree/main/CONTRIBUTING.md) for an overview of our processes
- See [DEVELOPMENT.md](https://github.com/tektoncd/chains/tree/main/DEVELOPMENT.md) for how to get started
- See [ROADMAP.md](https://github.com/tektoncd/chains/tree/main/ROADMAP.md) for the current roadmap Check out our good first
  issues and our help wanted issues to get started!
- See [releases.md](https://github.com/tektoncd/chains/tree/main/releases.md) for our release cadence and processes
