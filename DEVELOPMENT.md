...
- [hugo v0.147.0 (EXTENDED VERSION)](https://github.com/gohugoio/hugo/releases/v0.147.0) — same version as `.github/workflows/deploy.yml`, `netlify.toml`, and the official `.deb` installed in `Dockerfile`
